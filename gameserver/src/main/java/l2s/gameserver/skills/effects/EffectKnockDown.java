...
public class EffectKnockDown extends EffectFlyAbstract
{
	...
	public void onStart()
	{
		...
		getEffected().broadcastPacket(new FlyToLocation(getEffected(), new Location(_x, _y, _z), FlyToLocation.FlyType.PUSH_DOWN_HORIZONTAL, getFlySpeed(), getFlyDelay(), getFlyAnimationSpeed()));
