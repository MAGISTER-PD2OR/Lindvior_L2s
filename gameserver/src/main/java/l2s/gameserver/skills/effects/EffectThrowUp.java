...
public class EffectThrowUp extends EffectFlyAbstract
{
	...
	public void onStart()
	{
		...
		getEffected().broadcastPacket(new FlyToLocation(getEffected(), new Location(_x, _y, _z), FlyToLocation.FlyType.THROW_UP, getFlySpeed(), getFlyDelay(), getFlyAnimationSpeed()));
