...
public class EffectShadowStep extends EffectFlyAbstract
{
	...
	public void onStart()
	{
		...
		getEffector().broadcastPacket(new FlyToLocation(getEffector(), new Location(_x, _y, _z), FlyToLocation.FlyType.DUMMY, getFlySpeed(), getFlyDelay(), getFlyAnimationSpeed()));
