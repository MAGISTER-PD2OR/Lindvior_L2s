...
public class BlockList
{
	...
	public void add(String name)
	{
		...
		_owner.sendPacket(new SystemMessage2(SystemMsg.S1_HAS_BEEN_ADDED_TO_YOUR_IGNORE_LIST).addString(name));
	...
	public void remove(String name)
	{
		...
		_owner.sendPacket(new SystemMessage2(SystemMsg.S1_HAS_BEEN_REMOVED_FROM_YOUR_IGNORE_LIST).addString(name));
