...
public class Quest
{
	...
	public void addRaceCheck(boolean human, boolean elf, boolean delf, boolean orc, boolean dwarf, boolean kamael)
	{
		_startConditionList.add(new PlayerRaceCondition(human, elf, delf, orc, dwarf, kamael));
	}
	...
	protected void showHtmlFile(Player player, NpcInstance npc, String fileName, boolean showQuestInfo, Object... arg)
	{
		...
		NpcHtmlMessage npcReply = showQuestInfo ? new ExNpcQuestHtmlMessage(player, npc, getQuestIntId()) : new NpcHtmlMessage(player, npc);
