...
public final class QuestState
{
	...
	public void showTutorialHTML(String html)
	{
		...
		player.sendPacket(new TutorialShowHtml(TutorialShowHtml.NORMAL_WINDOW, text));
	}
	...
	public void showTutorialClientHTML(String fileName)
	{
		...
		if(player == null)
			return;
		player.sendPacket(new TutorialShowHtml(TutorialShowHtml.LARGE_WINDOW, "..\\L2text\\" + fileName + ".htm"));
	}
