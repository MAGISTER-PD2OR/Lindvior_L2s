...
public final class AwakeningManagerInstance extends NpcInstance
{
	...
	public void showChatWindow(Player player, int val, Object... arg)
	{
		if(val == 0)
		{
			...
			if(!player.getClassId().isOfLevel(ClassLevel.THIRD) || player.getLevel() < 85 || ItemFunctions.getItemCount(player, SCROLL_OF_AFTERLIFE) < 1 || player.getClassId() == ClassId.JUDICATOR)
			{
