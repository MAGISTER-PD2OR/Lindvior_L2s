...
import l2s.gameserver.network.l2.s2c.ExEnchantSkillInfoDetail;
...
public final class RequestExEnchantSkillInfoDetail extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		activeChar.sendPacket(new ExEnchantSkillInfoDetail(_skillId, _skillLvl, sp, esd.getRate(activeChar), bookId, bookCount, adenaCount));
	}
}