...
public class RequestChangeAttributeItem extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		SystemMessage2 msg = new SystemMessage2(SystemMsg.IN_THE_ITEM_S1_ATTRIBUTE_S2_SUCCESSFULLY_CHANGED_TO_S3);
		msg.addName(item);
		msg.addElementName(oldElement);
		msg.addElementName(newElement);
		activeChar.sendPacket(msg);
		activeChar.sendPacket(new InventoryUpdate().addModifiedItem(activeChar, item));
