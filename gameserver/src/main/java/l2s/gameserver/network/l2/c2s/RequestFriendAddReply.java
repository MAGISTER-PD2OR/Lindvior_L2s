...
import l2s.gameserver.network.l2.s2c.L2FriendList;
...
public class RequestFriendAddReply extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		requestor.sendPacket(SystemMsg.THAT_PERSON_HAS_BEEN_SUCCESSFULLY_ADDED_TO_YOUR_FRIEND_LIST, new SystemMessage2(SystemMsg.S1_HAS_JOINED_AS_A_FRIEND).addName(requestor), new L2FriendList(requestor));
		activeChar.sendPacket(SystemMsg.THAT_PERSON_HAS_BEEN_SUCCESSFULLY_ADDED_TO_YOUR_FRIEND_LIST, new SystemMessage2(SystemMsg.S1_HAS_JOINED_AS_A_FRIEND).addName(requestor), new L2FriendList(activeChar));
	}
}