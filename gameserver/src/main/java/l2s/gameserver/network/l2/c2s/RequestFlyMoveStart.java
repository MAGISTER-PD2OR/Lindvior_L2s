...
public class RequestFlyMoveStart extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(!activeChar.getClassId().isOfLevel(ClassLevel.AWAKED) && !activeChar.isGM())
			return;
		...
		activeChar.sendPacket(new FlyToLocation(activeChar, destLoc, FlyToLocation.FlyType.DUMMY, 0, 0, 0));
