...
public class RequestJoinAlly extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(obj == null || !obj.isPlayer() || obj == activeChar)
		{
			...
			if(fakePlayer != null)
			{
				activeChar.sendPacket(new SystemMessage2(SystemMsg.S1_IS_NOT_A_CLAN_LEADER).addName(fakePlayer));
				return;
			}
		...
		{
			activeChar.sendPacket(new SystemMessage2(SystemMsg.S1_IS_NOT_A_CLAN_LEADER).addName(target));
			return;
		}
