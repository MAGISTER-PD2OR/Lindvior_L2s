...
public class RequestVoteNew extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		SystemMessage2 sm = new SystemMessage2(SystemMsg.YOU_HAVE_RECOMMENDED_C1_YOU_HAVE_S2_RECOMMENDATIONS_LEFT);
		sm.addName(target);
		sm.addInteger(activeChar.getRecomLeft());
		activeChar.sendPacket(sm);

		sm = new SystemMessage2(SystemMsg.YOU_HAVE_BEEN_RECOMMENDED_BY_C1);
