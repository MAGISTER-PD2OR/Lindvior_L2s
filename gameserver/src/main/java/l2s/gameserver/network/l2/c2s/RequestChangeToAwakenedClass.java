...
public class RequestChangeToAwakenedClass extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		if(npc instanceof AwakeningManagerInstance)
		{
			...
			activeChar.broadcastPacket(new SocialAction(activeChar.getObjectId(), SocialAction.AWAKENING));
		...
		else
		{
			...
			activeChar.broadcastUserInfo(true);
			activeChar.broadcastPacket(new SocialAction(activeChar.getObjectId(), SocialAction.REAWAKENING));
		}
