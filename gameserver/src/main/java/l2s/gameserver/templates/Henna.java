...
public class Henna
{
	...
	public Henna(int symbolId, int dyeId, long drawPrice, long drawCount, long removePrice, long removeCount, int wit, int intA, int con, int str, int dex, int men, TIntSet classes, TIntIntMap skills)
	{
		_symbolId = symbolId;
		_dyeId = dyeId;
