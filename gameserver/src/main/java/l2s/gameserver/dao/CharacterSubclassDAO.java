...
public class CharacterSubclassDAO
{
	...
	public boolean insert(int objId, int classId, int dafaultClassId, long exp, int sp, double curHp, double curMp, double curCp, double maxHp, double maxMp, double maxCp, int level, boolean active, SubClassType type, int certification, int dualCertification, int vitality, int vitalityUsedPotions)
	{
		Connection con = null;
