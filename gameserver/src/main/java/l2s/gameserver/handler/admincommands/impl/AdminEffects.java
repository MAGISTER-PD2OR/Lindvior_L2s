...
import l2s.gameserver.network.l2.s2c.ExShowUsmVideo;
	...
	public boolean useAdminCommand(Enum<?> comm, String[] wordList, String fullString, Player activeChar)
	{
		...
		switch(command)
		{
			...
			case admin_showusm:
				...
				activeChar.sendPacket(new ExShowUsmVideo(usmId));
				break;
			case admin_showchtml:
				...
				activeChar.sendPacket(new TutorialShowHtml(TutorialShowHtml.LARGE_WINDOW, "..\\L2text\\" + fileName + ".htm"));
				break;
		}
