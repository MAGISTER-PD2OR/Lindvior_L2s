...
public class ClanTable
{
	...
	public void startClanWar(Clan clan1, Clan clan2)
	{
		...
		clan1.broadcastToOnlineMembers(new SystemMessage2(SystemMsg.YOU_HAVE_DECLARED_A_CLAN_WAR_WITH_S1_CLAN_WAR_STARTS_IN_3_DAYS).addString(clan2.getName()));
		clan2.broadcastToOnlineMembers(new SystemMessage2(SystemMsg.S1_HAS_DECLARED_A_CLAN_WAR_CLAN_WAR_STARTS_IN_3_DAYS).addString(clan1.getName()));
	}
