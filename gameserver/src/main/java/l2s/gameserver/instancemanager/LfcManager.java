		...
		else
		{
			...
			if(winnerOn && looserOn)
			{
				...
				{	
					...
					winner.sendPacket(SystemMessage2.obtainItems(price, price_count, 0));			
...
*/			
	...
	public static void returnBid(Arenas arena)
	{
		...
		if(player1 != null)
		{
			...
			player1.sendPacket(SystemMessage2.obtainItems(returnId, returnCount, 0));			
		...
		if(player2 != null)
		{
			...
			player2.sendPacket(SystemMessage2.obtainItems(returnId, returnCount, 0));			
