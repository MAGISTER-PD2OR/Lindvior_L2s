...
public class RequestActionUse extends L2GameClientPacket
{
	...
	public static enum Action
	{
		...
		ACTION1123(1123, 2, 14767), // Осадный Удар
        ...
        // Cute Bear
		ACTION1106(1106, 5, 11278), // Bear Claw
		ACTION1107(1107, 5, 11279), // Bear Tumbling
        // Saber Tooth Cougar
		ACTION1108(1108, 5, 11280), // Cougar Bite
		ACTION1109(1109, 5, 11281), // Cougar Pounce
        // Grim Reaper
		ACTION1110(1110, 5, 11282), // Reaper Touch
		ACTION1111(1111, 5, 11283), // Reaper Power
        // Wynn Kai the Cat
		ACTION1124(1124, 5, 11323), // Feline Aggression
		ACTION1125(1125, 5, 11324), // Feline Stun
        // Wynn Feline King
		ACTION1126(1126, 5, 11325), // Feline Bite
		ACTION1127(1127, 5, 11326), // Feline Pounce
        // Wynn Feline Queen
		ACTION1128(1128, 5, 11327), // Feline Touch
		ACTION1129(1129, 5, 11328), // Feline Power
        // Wynn Merrow
		ACTION1130(1130, 5, 11332), // Unicorn's Aggression
		ACTION1131(1131, 5, 11333), // Unicorn's Stun
        // Wynn Magnus
		ACTION1132(1132, 5, 11334), // Unicorn's Bite
		ACTION1133(1133, 5, 11335), // Unicorn's Pounce
        // Wynn Seraphim
		ACTION1134(1134, 5, 11336), // Unicorn's Touch
		ACTION1135(1135, 5, 11337), // Unicorn's Power
        // Wynn Nightshade
		ACTION1136(1136, 5, 11341), // Phantom Aggression
		ACTION1137(1137, 5, 11342), // Phantom Stun
        // Wynn Spectral Lord
		ACTION1138(1138, 5, 11343), // Phantom Bite
		ACTION1139(1139, 5, 11344), // Phantom Pounce
        // Wynn Soulless
		ACTION1140(1140, 5, 11345), // Phantom Touch
		ACTION1141(1141, 5, 11346), // Phantom Power

		// Социальные действия
		ACTION12(12, 3, SocialAction.GREETING),
		ACTION13(13, 3, SocialAction.VICTORY),
		ACTION14(14, 3, SocialAction.ADVANCE),
		ACTION24(24, 3, SocialAction.YES),
		ACTION25(25, 3, SocialAction.NO),
		ACTION26(26, 3, SocialAction.BOW),
		ACTION29(29, 3, SocialAction.UNAWARE),
		ACTION30(30, 3, SocialAction.WAITING),
		ACTION31(31, 3, SocialAction.LAUGH),
		ACTION33(33, 3, SocialAction.APPLAUD),
		ACTION34(34, 3, SocialAction.DANCE),
		ACTION35(35, 3, SocialAction.SORROW),
		ACTION62(62, 3, SocialAction.CHARM),
		ACTION66(66, 3, SocialAction.SHYNESS),
		//TAUTI
		ACTION87(87, 3, SocialAction.PROPOSE),
		ACTION88(88, 3, SocialAction.PROVOKE),
		ACTION89(89, 3, SocialAction.BOASTING),

		// Парные социальные действия
		ACTION71(71, 4, SocialAction.COUPLE_BOW),
		ACTION72(72, 4, SocialAction.COUPLE_HIGH_FIVE),
		ACTION73(73, 4, SocialAction.COUPLE_DANCE);
